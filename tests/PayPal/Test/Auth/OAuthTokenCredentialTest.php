...
class OAuthTokenCredentialTest extends TestCase
{
    ...
    public function testGetAccessTokenUnit()
    {
        ...
        //{"clientId":{"clientId":"clientId","accessToken":"accessToken","tokenCreateTime":1421204091,"tokenExpiresIn":432000000}}
        AuthorizationCache::push($config, 'clientId', $cred->encrypt('accessToken'), 1421204091, 432000000);
